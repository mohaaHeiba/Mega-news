...
class HomePage extends GetView<HomeController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        // شيلنا الـ if الكبيرة اللي كانت هنا عشان الـ Scaffold يتبني دائماً
        ...
        return RefreshIndicator(
          ...
          child: CustomScrollView(
            ...
            slivers: [
              ...
              // 2. Sliver List (المحتوى كله هنا)
              SliverList(
                delegate: SliverChildListDelegate([
                  // ---------------------------------------------
                  // A. Categories Chips (دايماً ظاهرة)
                  // ---------------------------------------------
                  SizedBox(
                    height: 44,
                  ...
                  // ---------------------------------------------
                  // B. Conditional Logic (Content VS Empty State)
                  // ---------------------------------------------
                  if (!controller.isLoading.value &&
                      controller.articles.isEmpty)
                    // --- حالة مفيش أخبار (No News) ---
                    Container(
                      height: 400, // ارتفاع عشان تيجي في نص الشاشة تقريبا
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          AppGaps.h24,
                          // زرار إعادة المحاولة (اختياري بس مفيد)
                          ElevatedButton.icon(
                            onPressed: () => controller.fetchNews(),
                            icon: const Icon(Icons.refresh),
                            label: Text('Retry'), // تأكد من الترجمة
                    ...
                    Column(
                      children: [
                        ...
                        controller.isLoading.value
                            ...
                            : CarouselSlider(
                                items: controller.articles.take(5).map((
                                  article,
                                ) {
